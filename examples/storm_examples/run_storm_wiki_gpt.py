...
from knowledge_storm.rm import YouRM, BingSearch, BraveRM, SerperRM, DuckDuckGoSearchRM, TavilySearchRM, SearXNG ,JiraSearch
from knowledge_storm.utils import load_api_key


def main(args):
    load_api_key(toml_file_path='/Users/ashpreetsingh/Downloads/stanford-torm/storm-main/examples/storm_examples/secrets.toml')
    ...
    match args.retriever:
        case 'jira':
            rm = JiraSearch(k=engine_args.search_top_k)
        case 'bing':
...
if __name__ == '__main__':
    ...
    parser.add_argument('--retriever', default='jira')
